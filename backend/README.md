...
## Project Structure
    ...
    ├── testapiautoconnecto_72773  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_72773`
...
2. Clone this repo and `cd testapiautoconnecto_72773`
